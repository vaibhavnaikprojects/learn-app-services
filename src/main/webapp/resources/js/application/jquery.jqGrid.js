...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		grid.hDiv.style.width = (grid.width - bstw) + "px";	//vanaik replaced bstw with 0
			...
			if (o.url === 'clientArray') {
				...
				$.ajax($.extend({
						...
						if (stat === "success"){
							...
							if (ret===true) {
								...
								if(o.restoreAfterError === true) {
									//$($t).jqGrid("restoreRow",rowid, o.afterrestorefunc);	vanaik
								}
							}
						}
					},
					error:function(res,stat,err){
						...
						if($.isFunction(o.errorfunc) ) {
							o.errorfunc.call($t, rowid, res, stat, err);	//vanaik
						} else {
